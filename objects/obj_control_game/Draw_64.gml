...
if(instance_exists(obj_comida)) {
    //draw_line_colour(640/2, 360/2, obj_comida.x+GRID_TAM/2, obj_comida.y+GRID_TAM/2, c_ltgray, c_ltgray);
	//draw_line(obj_head.x+GRID_TAM/2, obj_head.y+GRID_TAM/2, obj_comida.x+GRID_TAM/2, obj_comida.y+GRID_TAM/2);
}
